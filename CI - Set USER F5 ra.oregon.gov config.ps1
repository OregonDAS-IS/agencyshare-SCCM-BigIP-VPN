...
if ($Run_As -eq "user"){
    ...
    if($user_file_status -eq 'configured' -or $user_file_status -eq 'no-file') { write-host "Configuration Present"; return 0}
...
$output = set_f5_config -Action monitor -Run_As user
